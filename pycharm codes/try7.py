...
#create Model
#define base model
def base_model(init_mode='uniform', activation='sigmoid', dropout_rate=0.1, learn_rate=0.001, momentum=0.6, neurons=200):
     model = Sequential()
     model.add(Dense(150, input_dim=219, init='uniform', activation='sigmoid'))
     model.add(Dropout(0.1))
     #model.add(Dense(50, init=init_mode, activation='softplus'))
     #model.add(Dropout(0.1))
...
clf = KerasRegressor(build_fn=base_model, verbose=2, batch_size=60, epochs=100)
n_folds = 5
